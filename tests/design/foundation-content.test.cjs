...
test('newly provisioned page defaults contain no unsupported business claims',()=>{
  ...
  assert.doesNotMatch(copy,/fully insured|guarantee|years? of experience|5,?000|trusted by|dependable|reliable|professional cleaning team|eco[- ]friendly|certified/i);
});
