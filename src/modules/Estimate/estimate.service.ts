    ...
    const estimate = await prisma.$transaction(async (tx) => {
        ...
        const created = await tx.estimate.create({
            data: {
                ...
                estimatedMin: payload.pricingType === "range" && payload.estimatedMin != null ? payload.estimatedMin : null,
                estimatedMax: payload.pricingType === "range" && payload.estimatedMax != null ? payload.estimatedMax : null,
                subtotal: payload.pricingType === "range" && payload.estimatedMin != null ? payload.estimatedMin : totals.subtotal,
                taxRate: totals.taxRate,
                tax: totals.tax,
                total: payload.pricingType === "range" && payload.estimatedMax != null ? payload.estimatedMax : totals.total,
    ...
    return prisma.$transaction(async (tx) => {
        ...
        return tx.estimate.update({
            ...
            data: {
                ...
                ...(payload.estimatedMin !== undefined && { estimatedMin: payload.estimatedMin }),
                ...(payload.estimatedMax !== undefined && { estimatedMax: payload.estimatedMax }),
                ...(totalsUpdate && {
                    subtotal: payload.pricingType === "range" && payload.estimatedMin != null ? payload.estimatedMin : totalsUpdate.subtotal,
                    labourCost: totalsUpdate.labourCost,
                    taxRate: totalsUpdate.taxRate,
                    tax: totalsUpdate.tax,
                    total: payload.pricingType === "range" && payload.estimatedMax != null ? payload.estimatedMax : totalsUpdate.total,
                }),
            },
            include: estimateInclude,
        });
