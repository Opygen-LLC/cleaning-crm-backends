...
const updatePaymentGatewayConfig = async (
    ...
    if (stripeWebhookSecret) data.stripeWebhookSecretMasked = mask(stripeWebhookSecret);
    if (paypalClientSecret)  data.paypalClientSecretMasked  = mask(paypalClientSecret);
