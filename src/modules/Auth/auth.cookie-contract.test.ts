...
vi.mock("../../config/ENV",()=>({ ACCESS_TOKEN_EXPIRES_IN:"15m", ACCESS_TOKEN_SECRET:"test-access-secret", REFRESH_TOKEN_EXPIRES_IN:"30d", REFRESH_TOKEN_SECRET:"test-refresh-secret", NODE_ENV:"production" }));
