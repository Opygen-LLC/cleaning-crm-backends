...
export const tenantListQuerySchema = z.object({
  ...
  lifecycleStatus: z.nativeEnum(TenantLifecycleStatus).optional(), page: z.string().regex(/^\d+$/).optional(), limit: z.string().regex(/^\d+$/).optional(),
});
...
export const hardDeleteSchema = z.object({ adminId: z.string().uuid(), confirmationText: z.literal("DELETE PERMANENTLY") });
